...
public class UpdaterService extends Service {
        ...
        mBroadcastReceiver =
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        } else if (UpdaterController.ACTION_INSTALL_PROGRESS.equals(
                                intent.getAction())) {
                            UpdateInfo update = mUpdaterController.getUpdate(downloadId);
                            setNotificationTitle(update);
            ...
            try {
                if (update.getStream() || Utils.isABUpdate(update.getFile())) {
                    ...
                    UpdateInstaller installer =
                            UpdateInstaller.getInstance(this, mUpdaterController);
                    installer.install(downloadId);
                }
            } catch (IOException e) {
    ...
    private void handleDownloadProgressChange(UpdateInfo update) {
        ...
        mNotificationStyle.bigText(getString(R.string.text_download_speed, eta, speed));
